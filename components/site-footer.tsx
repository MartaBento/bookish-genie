  ...
  return (
    <div className="text-center text-xs text-gray-400">
      ...
      <p className="mx-12 my-4">
        ...
        recommendations provided are based on available data up until January
        2022 and should be used only as suggestions. Please note that any data
        or input you provide may be processed and stored by OpenAI. All images
        are AI generated.
      </p>
    </div>
  );
